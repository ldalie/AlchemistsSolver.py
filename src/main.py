...
from buildAllAssignmentSets import *

def main():
    Facts = []
    # return all possible assignment sets, each with a multiplier of 1.
    possibleAssignmentSets = buildAllAssignmentSets()
    ...
    while isBoardNotComplete:
        ...
        assignmentProbabilities = calculateAssignmentProbabilities(possiblePermutations)
